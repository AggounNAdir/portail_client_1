...
import { Settings, Server, Check, X, RefreshCw } from 'lucide-react';
      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <div className="mt-4 space-y-4">
          ...
          <div className="rounded-xl bg-slate-50 p-3 text-xs text-slate-600">
            <span className="font-semibold text-slate-700">Mode Connecté Silwane :</span> Le client synchronise automatiquement les produits, commandes et factures.
          </div>
        </div>
