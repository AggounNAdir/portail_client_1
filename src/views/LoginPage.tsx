...
import { Package, Lock, User, Eye, EyeOff, AlertCircle, Loader2, ArrowRight, Server } from 'lucide-react';
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 p-4 sm:p-6">
      <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-6 shadow-xl sm:p-10 relative">
        ...
        <div className="mt-8 border-t border-slate-100 pt-4 flex flex-col items-center gap-2">
          <button
            type="button"
